...
public class MailList {
	...
	public static void main(String[] args) throws Exception{
        ...
        HttpPost httpost = new HttpPost("https://exmail.qq.com/cgi-bin/mail_list?"
        		+ "sid=dixFhLZ02ijwfi11,7&folderid=1");
